...
const StarButton: React.FC<StarButtonProps> = ({ 
  ...
  const buttonStyle: React.CSSProperties = {
    ...
    outline: 'none', // We'll handle focus visually
    borderRadius: '50%', // For focus ring
  };
  ...
  // Fallback star SVG if image fails to load
  ...
  return (
    ...
    >
      ...
      {/* Golden label that appears when active, hovered, or focused */}
